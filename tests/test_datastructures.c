...
static void test_hashtable_merge(void) {
    ...
    void *combine(void *v1, const void *v2) {
...
static HHashValue custom_hash_for_test(const void *p) {
    
    return ((uintptr_t)p >> 4) ^ 0x1234;
}
...
void register_datastructures_tests(void) {
    ...
    g_test_add_func("/core/datastructures/slist_remove_all_null_item", test_slist_remove_all_null_item);
    ...
    g_test_add_func("/core/datastructures/hashtable_get_precomp_null_key", test_hashtable_get_precomp_null_key);
    g_test_add_func("/core/datastructures/hashtable_get_precomp_hashval_mismatch", test_hashtable_get_precomp_hashval_mismatch);
    g_test_add_func("/core/datastructures/hashtable_get", test_hashtable_get);
    g_test_add_func("/core/datastructures/hashtable_ensure_capacity_resize", test_hashtable_ensure_capacity_resize);
    g_test_add_func("/core/datastructures/hashtable_put_raw_existing", test_hashtable_put_raw_existing);
    g_test_add_func("/core/datastructures/hashtable_put_raw_collision", test_hashtable_put_raw_collision);
    ...
    g_test_add_func("/core/datastructures/hashtable_equal_different_capacity", test_hashtable_equal_different_capacity);
    g_test_add_func("/core/datastructures/hashset_equal", test_hashset_equal);
    g_test_add_func("/core/datastructures/hashtable_del_hashval_mismatch", test_hashtable_del_hashval_mismatch);
    g_test_add_func("/core/datastructures/hashtable_equal_with_null_keys", test_hashtable_equal_with_null_keys);
    g_test_add_func("/core/datastructures/hashtable_equal_hashval_mismatch", test_hashtable_equal_hashval_mismatch);
    g_test_add_func("/core/datastructures/hashtable_equal_element_not_found", test_hashtable_equal_element_not_found);
