...
static void test_hammer_free_backend_with_params_null(void) {
    h_free_backend_with_params(NULL);
...
void register_hammer_tests(void) {
    g_test_add_func("/core/hammer/backend_available_invalid", test_hammer_backend_available_invalid);
    g_test_add_func("/core/hammer/backend_available_missing", test_hammer_backend_available_missing);
    ...
    g_test_add_func("/core/hammer/copy_backend_with_params_null_mm", test_hammer_copy_backend_with_params_null_mm);
    g_test_add_func("/core/hammer/copy_backend_with_params_null_be", test_hammer_copy_backend_with_params_null_be);
    g_test_add_func("/core/hammer/copy_backend_with_params_null_mm_both", test_hammer_copy_backend_with_params_null_mm_both);
    g_test_add_func("/core/hammer/copy_backend_with_params_invalid_backend", test_hammer_copy_backend_with_params_invalid_backend);
    g_test_add_func("/core/hammer/copy_backend_with_params_null_params", test_hammer_copy_backend_with_params_null_params);
    g_test_add_func("/core/hammer/copy_numeric_param", test_hammer_copy_numeric_param);
    g_test_add_func("/core/hammer/free_backend_with_params_null", test_hammer_free_backend_with_params_null);
    g_test_add_func("/core/hammer/free_backend_with_params_null_mm", test_hammer_free_backend_with_params_null_mm);
    g_test_add_func("/core/hammer/free_backend_with_params_unavailable_backend", test_hammer_free_backend_with_params_unavailable_backend);
    g_test_add_func("/core/hammer/free_backend_with_params_null_vtable", test_hammer_free_backend_with_params_null_vtable);
    g_test_add_func("/core/hammer/free_backend_with_params_null_free_params", test_hammer_free_backend_with_params_null_free_params);
    g_test_add_func("/core/hammer/free_backend_with_params_with_name", test_hammer_free_backend_with_params_with_name);
    g_test_add_func("/core/hammer/get_string_for_backend_invalid", test_hammer_get_string_for_backend_invalid);
    g_test_add_func("/core/hammer/get_string_for_backend_out_of_range", test_hammer_get_string_for_backend_out_of_range);
    g_test_add_func("/core/hammer/get_string_for_backend_valid", test_hammer_get_string_for_backend_valid);
    g_test_add_func("/core/hammer/get_string_for_backend_with_params_null_mm", test_hammer_get_string_for_backend_with_params_null_mm);
    g_test_add_func("/core/hammer/get_string_for_backend_with_params_null_be", test_hammer_get_string_for_backend_with_params_null_be);
