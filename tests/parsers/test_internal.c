...
// Test reshape_bits directly by calling it through the desugared CFG choice
static void test_reshape_bits_direct(void) {
    ...
    HParsedToken *reshaped_unsigned = desugared_unsigned->reshape(mock_res, desugared_unsigned->user_data);
    ...
    HParsedToken *reshaped_signed_pos = desugared_signed->reshape(mock_res, desugared_signed->user_data);
    ...
    HParsedToken *reshaped_signed_neg = desugared_signed->reshape(mock_res_neg, desugared_signed->user_data);
    ...
    HParsedToken *reshaped_signed_ff = desugared_signed->reshape(mock_res_ff, desugared_signed->user_data);
    ...
    HParsedToken *reshaped_uint32 = desugared_uint32->reshape(mock_res_32, desugared_uint32->user_data);
    ...
    HParsedToken *reshaped_int32_neg = desugared_int32->reshape(mock_res_32_neg, desugared_int32->user_data);
    ...
    HParsedToken *reshaped_empty_unsigned = desugared_unsigned->reshape(mock_res_empty, desugared_unsigned->user_data);
    ...
    HParsedToken *reshaped_empty_signed = desugared_signed->reshape(mock_res_empty, desugared_signed->user_data);
